...
IF NOT EXIST serviceUpdateClient.bat goto FIRSTTIME1
...
echo echo.
echo echo We are currently updating your Game contents, so please DO NOT:
echo echo.
echo echo 	- POWER OFF
echo echo 	- SHUT DOWN THIS Application
echo echo 	- DISCONNECT INTERNET SESSION
echo echo 	- CLOSE ANY COMMAND SERVICES
echo echo 	- RENAME/MODIFY ANY DIRECTORIES
echo echo 	- CLEARING/DELETING CACHE/TEMP FILES
echo echo.
echo echo Failure to comply with these instructions may result to the filesystem corruption and irreversable damage.
echo echo.
echo echo.
echo echo Status: Downloading new Update Contents from the RediPanda Proxy Network...
echo echo.
